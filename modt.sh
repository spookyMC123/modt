...
display_footer() {
    ...
    echo -e "  ${ACCENT}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
    echo -e ""
    echo -e "  ${LABEL}Support:${RESET}  ${INFO}support@nexohost.online${RESET}     ${LABEL}|${RESET}     ${LABEL}Website:${RESET}  ${HEADER_ACCENT}https://nexohost.com${RESET}"
    echo -e "  ${LABEL}Portal:${RESET}   ${INFO}portal.nexohost.online${RESET}      ${LABEL}|${RESET}     ${LABEL}Status:${RESET}   ${SUCCESS}status.nexohost.com${RESET}"
    echo -e ""
    echo -e "${BORDER}  ────────────────────────────────────────────────────────────────────────────────${RESET}"
    echo -e ""
}
